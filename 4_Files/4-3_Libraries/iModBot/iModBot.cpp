...
// This two variables store a value that will be subtracted to the wheel PWM in order to adjust the speed
// This method may be romoved in the future
...
// "L293D 4 channel module" motor driver module
// IN1 & IN2 control the right engine     /* PINS */
byte _IN1 = 4; // ESP32 GPIO15 and GPIO5 are HIGH during boot.
byte _IN2 = 16;
//IN3 & IN4 control the left engine
byte _IN3 = 17;
byte _IN4 = 18;
