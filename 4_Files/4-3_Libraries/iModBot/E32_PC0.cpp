...
static void pcnt_init(void)
{
  pcnt_config_t pcnt_config = {
      ...
      .pulse_gpio_num = PCNT_INPUT_SIG_IO_v,
...
void E32_PC0::begin(byte pin)
{
  PCNT_INPUT_SIG_IO_v=pin;
  pinMode(PCNT_INPUT_SIG_IO_v, INPUT_PULLUP);
